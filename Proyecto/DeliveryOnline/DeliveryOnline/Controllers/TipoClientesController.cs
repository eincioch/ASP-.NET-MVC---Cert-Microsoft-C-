...
namespace DeliveryOnline.Controllers
{
    public class TipoClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClienteId,Descripcion")] TipoCliente tipoCliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteId,Descripcion")] TipoCliente tipoCliente)
        {
            if (ModelState.IsValid)
            {
